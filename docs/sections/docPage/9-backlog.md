...
**US13** - Como usuário, quero atualizar informações de grupos de viajantes, caso haja alguma mudança no grupo durante a viagem. <br>
...
**US17** - Como usuário, quero receber notificações por e-mail antes do início agendado de uma rota turística. <br>
...
**US19** - Como usuário, quero visualizar minha localização em tempo real. <br>
